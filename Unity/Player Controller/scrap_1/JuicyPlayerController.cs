...
namespace ONYX {
    public class JuicyPlayerController : MonoBehaviour {
        ...
        [SerializeField] private float default_speed_lerp_value = 100f;
        [SerializeField] private float crouch_speed_lerp_value = 10f;
        ...
        [SerializeField] private float crouch_boost = 10f;
        ...
        [ReadOnly] [SerializeField] private float target_speed;
        [ReadOnly] [SerializeField] private float speed_lerp_value;
        ...
        private void Update(){
            ...
            float blend = 1 - Mathf.Pow(0.5f, Time.deltaTime * speed_lerp_value);
            speed = Mathf.Lerp(speed, target_speed, blend);
            ...
            AddCrouchBostToSpeed(state != last_state && state == PlayerState.Crouching);
        ...
        private void AddCrouchBostToSpeed(bool _just_crouched){
            if(!_just_crouched) return;
            speed += crouch_boost;
        }
        ...
        private void CalculateSlideVelocity(){
            // get the ground angle with a ray cast using "slope_check_distance" for the distance
        }
        ...
        private void DoCrouching(bool crouching){
            if(crouching){
                ...
                speed_lerp_value = crouch_speed_lerp_value;
            }else{
                height = default_height;
                speed_lerp_value = default_speed_lerp_value;
            }
